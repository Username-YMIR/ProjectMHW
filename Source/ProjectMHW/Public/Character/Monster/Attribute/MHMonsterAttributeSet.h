...
#include "Combat/Attributes/MHAttributeSetMacro.h"
...
public:
	UPROPERTY(BlueprintReadOnly, Category="Attributes|Monster", ReplicatedUsing=OnRep_Rage)
	FGameplayAttributeData Rage;
	ATTRIBUTE_ACCESSORS(UMHMonsterAttributeSet, Rage)

	UPROPERTY(BlueprintReadOnly, Category="Attributes|Monster", ReplicatedUsing=OnRep_RageThreshold)
	FGameplayAttributeData RageThreshold;
	ATTRIBUTE_ACCESSORS(UMHMonsterAttributeSet, RageThreshold)
...
protected:
	...
	UFUNCTION()
	void OnRep_RageThreshold(const FGameplayAttributeData& OldValue);
};
